import StatsLink from "@/components/stats-home/stats-link";
...
import ClientUserContextProvider from "@/context/client-user-context-provider";
        ...
        <>
            <ClientUserContextProvider>
                <List
                    ...
                    '
                >
                    <UserLayoutListItem href='/user/rooms' icon={<FaUserGroup />}>Your Rooms</UserLayoutListItem>
                    <StatsLink />
                </List>
                {children}
            </ClientUserContextProvider>
