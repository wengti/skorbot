    ...
    <FloatingPortal>
      <FloatingFocusManager context={floatingContext} modal={context.modal}>
        <div
          ...
          className="bg-(--color-pale) dark:bg-(--color-dark-pale) max-w-80 rounded-xl border border-popover-border p-5 pt-3 z-2"
        >
          <FloatingArrow
            ref={context.arrowRef}
            context={floatingContext}
            className="fill-(--color-pale) dark:fill-(--color-dark-pale) [&>path:last-of-type]:stroke-popover-border"
            width={18}
            height={18}
